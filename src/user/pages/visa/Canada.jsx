...
const Canada = () => {
  ...
  const processSteps = [
    "Choose the correct Canada visitor visa category based on your travel purpose.",
    ...
    <div className="bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="mt-6 text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 leading-tight">
                Apply for Your Canada Visitor Visa With Expert Guidance
              </h1>

              <p className="mt-6 text-lg text-gray-600 leading-8 max-w-2xl">
                Get complete support for your Canada visitor visa application,
                from documentation guidance and application assistance to final
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-5xl font-extrabold text-gray-900">
              Canada Visa Category We Support
            </h2>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-extrabold text-gray-900 leading-tight">
                Documents You May Need for a Canada Visitor Visa
              </h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-5xl font-extrabold text-gray-900">
              How We Help With Your Canada Visitor Visa
            </h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-extrabold text-gray-900 leading-tight">
                Avoid These Common Canada Visitor Visa Errors
              </h2>
              <p className="mt-5 text-lg text-gray-600 leading-8">
      ...
      <section className="py-20 bg-[#0f172a]">
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <div className="rounded-[36px] bg-gradient-to-r from-[#f2653a] to-red-400 p-10 md:p-14 text-center shadow-2xl">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-white/20 text-white mb-6">
              <BadgeCheck size={30} />
            </div>

            <h2 className="text-3xl md:text-5xl font-extrabold text-white">
              Ready to Start Your Canada Visitor Visa Application?
            </h2>
