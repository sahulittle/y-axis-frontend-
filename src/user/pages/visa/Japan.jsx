          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="mt-6 text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 leading-tight">
                Apply for Your Japan Visa With Expert Guidance
              </h1>

              <p className="mt-6 text-lg text-gray-600 leading-8 max-w-2xl">
                Get complete support for your Japan visa application with
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-5xl font-extrabold text-gray-900">
              Japan Visa Categories We Support
            </h2>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-extrabold text-gray-900 leading-tight">
                Documents You May Need for Japan Visa Processing
              </h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-5xl font-extrabold text-gray-900">
              How We Help With Your Japan Visa Application
            </h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-extrabold text-gray-900 leading-tight">
                Avoid These Common Japan Visa Errors
              </h2>
              <p className="mt-5 text-lg text-gray-600 leading-8">
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <div className="rounded-[36px] bg-gradient-to-r from-[#f2653a] to-indigo-500 p-10 md:p-14 text-center shadow-2xl">
            ...
            <h2 className="text-3xl md:text-5xl font-extrabold text-white">
              Ready to Start Your Japan Visa Application?
            </h2>
            ...
            <p className="mt-5 text-lg text-white/90 max-w-3xl mx-auto leading-8">
              ...
              preparation, and a smoother Japan visa application process.
            </p>
